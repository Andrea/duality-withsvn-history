  ...
  <object dataType="Class" type="Duality.Resources.Scene" id="1">
    ...
    <objectManager dataType="Class" type="Duality.ObjectManagers.GameObjectManager" id="2">
      ...
      <allObj dataType="Class" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="9">
        <_items dataType="Array" type="Duality.GameObject[]" id="10" length="8">
              ...
              <customSerialIO>
                ...
                <values dataType="Array" type="Duality.Component[]" id="38" length="3">
                  <object dataType="Class" type="Duality.Components.Transform" id="39">
                    <pos dataType="Struct" type="OpenTK.Vector3">
                      <X dataType="Float">48.0782852</X>
                      <Y dataType="Float">-342.502045</Y>
                      <Z dataType="Float">0</Z>
                    </pos>
                    <vel dataType="Struct" type="OpenTK.Vector3">
                      <X dataType="Float">0</X>
          ...
          <object dataType="Class" type="Duality.GameObject" id="91">
            ...
            <compMap dataType="Class" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="92" surrogate="true">
              ...
              <customSerialIO>
                <keys dataType="Array" type="System.Type[]" id="93" length="3">
                  <object dataType="ObjectRef">14</object>
                  <object dataType="Type" id="94" value="Tetris.BlockRenderer" />
                  <object dataType="ObjectRef">16</object>
                </keys>
                <values dataType="Array" type="Duality.Component[]" id="95" length="3">
                  <object dataType="Class" type="Duality.Components.Transform" id="96">
                    <pos dataType="Struct" type="OpenTK.Vector3">
                      <X dataType="Float">68.44083</X>
                      <Y dataType="Float">-130.777267</Y>
                      <Z dataType="Float">0</Z>
                    </pos>
                    <vel dataType="Struct" type="OpenTK.Vector3">
                      <X dataType="Float">0</X>
                    ...
                    <deriveAngle dataType="Bool">true</deriveAngle>
                    <extUpdater dataType="Class" type="Duality.Components.Collider" id="97">
                      <bodyType dataType="Enum" type="Duality.Components.Collider+BodyType" name="Dynamic" value="1" />
                      <linearDamp dataType="Float">0</linearDamp>
                      <angularDamp dataType="Float">0</angularDamp>
                      <fixedAngle dataType="Bool">false</fixedAngle>
                      ...
                      <colCat dataType="Enum" type="FarseerPhysics.Dynamics.Category" name="Cat1" value="1" />
                      <colWith dataType="Enum" type="FarseerPhysics.Dynamics.Category" name="All" value="2147483647" />
                      <shapes dataType="Class" type="System.Collections.Generic.List`1[[Duality.Components.Collider+ShapeInfo]]" id="98">
                        <_items dataType="Array" type="Duality.Components.Collider+ShapeInfo[]" id="99" length="4">
                          <object dataType="Class" type="Duality.Components.Collider+PolyShapeInfo" id="100">
                            <vertices dataType="Array" type="OpenTK.Vector2[]" id="101" length="4">
                              <object dataType="Struct" type="OpenTK.Vector2">
                            ...
                            <parent dataType="ObjectRef">97</parent>
                            <density dataType="Float">1</density>
                            <friction dataType="Float">0.3</friction>
                            <restitution dataType="Float">0.3</restitution>
                            <sensor dataType="Bool">false</sensor>
                          ...
                          <object dataType="Class" type="Duality.Components.Collider+PolyShapeInfo" id="104">
                          ...
                          <object dataType="Class" type="Duality.Components.Collider+PolyShapeInfo" id="106">
                            <vertices dataType="Array" type="OpenTK.Vector2[]" id="107" length="4">
                              <object dataType="Struct" type="OpenTK.Vector2">
                                <X dataType="Float">0</X>
                                <Y dataType="Float">0</Y>
                              </object>
                      ...
                      <joints dataType="Class" type="System.Collections.Generic.List`1[[Duality.Components.Collider+JointInfo]]" id="108">
                        <_items dataType="Array" type="Duality.Components.Collider+JointInfo[]" id="109" length="0" />
                        <_size dataType="Int">0</_size>
                        <_version dataType="Int">0</_version>
                      </joints>
                  ...
                  <object dataType="Class" type="Tetris.BlockRenderer" id="110">
                    <sharedMat dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Material]]">
                      <contentPath dataType="String">Data\BlockA.Material.res</contentPath>
                    </sharedMat>
                    <colorTint dataType="Struct" type="Duality.ColorFormat.ColorRgba">
                      <r dataType="Byte">255</r>
                      <g dataType="Byte">255</g>
            ...
            <compList dataType="Class" type="System.Collections.Generic.List`1[[Duality.Component]]" id="111">
              <_items dataType="Array" type="Duality.Component[]" id="112" length="4">
            ...
            <active dataType="Bool">true</active>
            <disposed dataType="Bool">false</disposed>
            <compTransform dataType="ObjectRef">96</compTransform>
            <EventComponentAdded dataType="ObjectRef">29</EventComponentAdded>
            <EventComponentRemoving dataType="ObjectRef">32</EventComponentRemoving>
            <EventCollisionBegin />
            <EventCollisionEnd />
      ...
      <Registered dataType="Delegate" type="System.EventHandler`1[[Duality.ObjectManagerEventArgs`1[[Duality.GameObject]]]]" id="113" multi="true">
        <object dataType="MethodInfo" id="114" value="M:Duality.Resources.Scene:objectManager_Registered(System.Object,Duality.ObjectManagerEventArgs`1[[Duality.GameObject]])" />
        <object dataType="ObjectRef">1</object>
        <object dataType="Array" type="System.Delegate[]" id="115" length="1">
          <object dataType="ObjectRef">113</object>
        </object>
      </Registered>
      <Unregistered dataType="Delegate" type="System.EventHandler`1[[Duality.ObjectManagerEventArgs`1[[Duality.GameObject]]]]" id="116" multi="true">
        <object dataType="MethodInfo" id="117" value="M:Duality.Resources.Scene:objectManager_Unregistered(System.Object,Duality.ObjectManagerEventArgs`1[[Duality.GameObject]])" />
        <object dataType="ObjectRef">1</object>
